...
parser.add_argument('--dataset_path', default='./datasets/Tmall/', help='dataset directory path: datasets/diginetica/yoochoose1_4/yoochoose1_64')
parser.add_argument('--batch_size', type=int, default=256, help='input batch size 512')
...
parser.add_argument('--lr_dc', type=float, default=0.06, help='learning rate decay rate')
